...
from resources.alert_rules.alert_rule_dal import create_alert_rule_dal, update_alert_rule_dal,get_all_alert_rules_dal,delete_alert_rule_dal , get_all_alert_rules_by_symbol_dal
...
def get_all_alert_rules_by_symbol(symbol: str,session):
     return get_all_alert_rules_by_symbol_dal(symbol, session)